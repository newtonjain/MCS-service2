...
var CreateExamples = function () {
    ...
    this.createPageWithSimpleText = function (accessToken, callback) {
        ...
        var htmlPayload =
            ...
            "</head>" +
            "<body>" +
            "    <p> Some random text <i>formatted</i>" +
            "    <b>text</b></p>" +
            "</body>" +
            "</html>";
    ...
    this.jarvisCreatePageWithSimpleText = function(accessToken, callback, text, summary) {
        var htmlPayload =
            "<!DOCTYPE html>" +
            "<html>" +
            "<head>" +
            "    <title>A page created by Jarvis Note</title>" +
            "    <meta name=\"created\" content=\"" + dateTimeNowISO() + "\">" +
            "</head>" +
              "<body>" +
            "    <p style='white-space:pre-wrap'>" + text + "</p>" + "<br>" +
